...
| `api/` | The FastAPI app factory, the JSON recipe-CRUD/household-preferences/meal-plan/shopping-list routes, and the server-rendered HTML routes (recipe library, settings, weekly plan, shopping list). |
